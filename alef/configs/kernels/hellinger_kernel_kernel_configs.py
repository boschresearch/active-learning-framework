...
class HellingerKernelKernelSobolVirtualPoints(BasicHellingerKernelKernelConfig):
    use_sobol_virtual_points: bool = True
    name = "HellingerKernelKernelSobolVirtualPoints"
