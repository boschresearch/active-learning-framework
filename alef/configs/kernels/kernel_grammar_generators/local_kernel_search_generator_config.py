...
class FlatLocalKernelSearchSpaceConfig(BaseKernelGrammarGeneratorConfig):
    name: str = "FlatLocalKernelSearchSpace"


class BigLocalNDimFullKernelsGrammarGeneratorConfig(BaseKernelGrammarGeneratorConfig):
    name: str = "BigLocalNDimFullKernelsGrammarGenerator"
