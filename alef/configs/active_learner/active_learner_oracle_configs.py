...
class BasicActiveLearnerOracleConfig(BaseSettings):
    ...
    acquisiton_optimization_type: OracleALAcquisitionOptimizationType = (
        OracleALAcquisitionOptimizationType.RANDOM_SHOOTING
    )


class PredVarActiveLearnerOracleConfig(BasicActiveLearnerOracleConfig):
    acquisition_function_config: BaseALAcquisitionFunctionConfig = BasicPredVarianceConfig()


class PredEntropyActiveLearnerOracleConfig(BasicActiveLearnerOracleConfig):
    acquisition_function_config: BaseALAcquisitionFunctionConfig = BasicPredEntropyConfig()


class RandomActiveLearnerOracleConfig(BasicActiveLearnerOracleConfig):
