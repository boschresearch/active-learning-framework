...
class GreedyKernelSearchNumNeighboursLimitedConfig(BaseGreedyKernelSearchConfig):
    limit_num_visited_neighbours: bool = True
    max_number_of_visited_neigbours: int = 6
    name = "GreedyKernelSearchNumNeighboursLimited"
