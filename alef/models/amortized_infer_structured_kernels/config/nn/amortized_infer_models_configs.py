...
from alef.models.amortized_infer_structured_kernels.config.nn.dataset_encoder_configs import (
...
from alef.models.amortized_infer_structured_kernels.config.nn.noise_predictor_configs import (
...
class BasicDimWiseAdditiveKernelAmortizedModelConfig(BasicAmortizedInferenceModelConfig):
    ...
    kernel_encoder_config: BaseKernelEncoderConfig = KernelEncoderConfig(
...
class SmallerDimWiseAdditiveKernelWithNoiseAmortizedModelConfig(BasicAmortizedInferenceModelConfig):
    ...
    kernel_encoder_config: BaseKernelEncoderConfig = SmallKernelEncoderConfig(
        dataset_enc_dim=dataset_encoder_config.output_embedding_dim
    )
    noise_predictor_config: BaseNoisePredictorConfig = NoisePredictorConfig(
        kernel_embedding_dim=kernel_encoder_config.hidden_dim,
...
class WiderStandardCrossAttentionKernelEncSharedDatasetEncMLPWrapperAmortizedModelConfig(
...
class SmallerStandardCrossAttentionKernelEncSharedDatasetEncMLPWrapperAmortizedModelConfig(
    BasicAmortizedInferenceModelConfig
):
    """
    Config that is not persistent - for changing experiments - config gets logged anyway
...
class ExperimentalCrossAttentionKernelEncSharedDatasetEncMLPWrapperAmortizedModelConfig(
    BasicAmortizedInferenceModelConfig
):
    """
    Config that is not persistent - for changing experiments - config gets logged anyway
...
class SmallerStandardNoDropoutCrossAttentionKernelEncSharedDatasetEncMLPWrapperAmortizedModelConfig(
    BasicAmortizedInferenceModelConfig
):
    """
    Config that is not persistent - for changing experiments - config gets logged anyway
...
class SmallerStandardSmallNoiseBoundWithDropoutCrossAttentionKernelEncSharedDatasetEncMLPWrapperAmortizedModelConfig(
    BasicAmortizedInferenceModelConfig
):
    """
    Config that is not persistent - for changing experiments - config gets logged anyway
    ...
    name: str = (
        "SmallerStandardSmallNoiseBoundWithDropoutCrossAttentionKernelEncSharedDatasetEncMLPWrapperAmortizedModel"
    )
    dropout_p: float = 0.05
    dataset_encoder_config: BaseDatasetEncoderConfig = EnrichedStandardDatasetEncoderConfig(
        dim_intermediate_bert=512, dataset_encoding_num_att_2=4, dataset_encoding_num_att_4=4, dropout_p=dropout_p
...
class ExperimentalSmallerStandardCrossAttentionKernelEncSharedDatasetEncMLPWrapperAmortizedModelConfig(
    BasicAmortizedInferenceModelConfig
):
    """
    Config that is not persistent - for changing experiments - config gets logged anyway
...
class DeeperCrossAttentionKernelEncSharedDatasetEncMLPWrapperAmortizedModelConfig(BasicAmortizedInferenceModelConfig):
    ...
    dataset_encoder_config: BaseDatasetEncoderConfig = EnrichedDatasetEncoderConfig(
        dataset_encoding_num_att_1=6,
        dataset_encoding_num_att_2=8,
        dataset_encoding_num_att_3=6,
        dataset_encoding_num_att_4=8,
    )
    kernel_encoder_config: BaseKernelEncoderConfig = CrossAttentionMLPKernelEncoderConfig(
