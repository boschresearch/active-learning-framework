...
if __name__ == "__main__":
    for i in range(0, 20):
        X = np.random.uniform(0, 0.5, (200, 2))
        warper = Warper()
        X_warped = warper.apply(X)
        plotter2d = Plotter2D(2)
        plotter2d.add_datapoints(X, "green", 0)
        plotter2d.add_datapoints(X_warped, "green", 1)
        plotter2d.show()
