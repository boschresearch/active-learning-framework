...
from alef.models.amortized_infer_structured_kernels.data_generators.warper import Warper
from alef.models.amortized_infer_structured_kernels.gp.base_kernels import (
    get_kernel_embeddings_and_kernel_mask,
)
from alef.models.amortized_infer_structured_kernels.nn.dataset_encoder import get_padded_dataset_and_masks
from alef.utils.utils import read_dict_from_json, read_list_from_file
from alef.models.amortized_infer_structured_kernels.data_generators.simulator import (
    SimulatedDataset,
...
class DatasetOfDatasets(Dataset):
    def __init__(
        ...
        train_dimension_index_file, val_dimension_index_file, test_dimension_index_file = (
            generator_class.get_dimension_index_file_names()
        )
...
def collate_fn_dim_wise_additive_kernel_gen(
    batch, normalize_datasets: bool, warp_inputs: bool, return_kernel_parameter_lists: bool
):
    warper = Warper()
    X_list = []
    y_list = []
