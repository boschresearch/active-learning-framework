...
"""
The following classes are copied and then adapted from (https://github.com/PrincetonLIPS/AHGP Licensed under the MIT License):
Linear, MultiheadAttention, AttentionLayer, Attention
"""
