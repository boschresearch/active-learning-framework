...
from alef.models.amortized_infer_structured_kernels.gp.base_kernels import BaseKernelEvalMode
from alef.models.amortized_infer_structured_kernels.nn.module import Linear
...
class BaseNoiseVariancePredictorHead(nn.Module):
    ...
    def forward(
        ...
        dimwise_dataset_encoding: torch.Tensor,
