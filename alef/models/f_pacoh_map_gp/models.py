...
from alef.models.f_pacoh_map_gp.util import find_root_by_bounding
...
def _mul_broadcast_shape(*shapes, error_msg=None):
    """
    This code is copied from gpytorch 1.7.0 (gpytorch.utils.broadcasting._mul_broadcast_shape)
    """
