...
class BaseKernelGrammarSearchSpace:
    ...
    def __init__(self, input_dimension: int):
        ...
        self.dimension_filling_bases: List[BaseKernelConfig] = None
        self.name = None
        self.has_single_dimensions = None
    ...
    def get_dimension_filling_expressions(self):
        expressions = []
        for kernel_config in self.dimension_filling_bases:
            expression = ElementaryKernelGrammarExpression(KernelFactory.build(kernel_config))
            expression.set_generator_name(self.name)
            expressions.append(expression)
        return expressions

    def get_neighbour_expressions(
        self, grammar_expression: BaseKernelGrammarExpression
    ) -> List[BaseKernelGrammarExpression]:
        """
            ...
            for operator in self.operator_list:
                for base_kernel_config in self.base_kernel_config_list:
                    ...
                    if isinstance(grammar_expression, ElementaryKernelGrammarExpression):
                        ...
                        new_elementary_expression = ElementaryKernelGrammarExpression(
                            KernelFactory.build(base_kernel_config)
                        )
                        new_expression = KernelGrammarExpression(copied_expression, new_elementary_expression, operator)
                    elif isinstance(grammar_expression, KernelGrammarExpression):
                        copied_expression.extend_sub_expression_at_index(
                            index, operator, KernelFactory.build(base_kernel_config)
                        )
    ...
    def get_neighbour_at_index(
        self, grammar_expression: BaseKernelGrammarExpression, index: int
    ) -> BaseKernelGrammarExpression:
        """
        ...
        if index < len(elementary_indexes) * len(self.base_kernel_config_list):
            ...
            subexpression_index = subexpression_indexes[
                int(index / (len(self.operator_list) * len(self.base_kernel_config_list)))
            ]
            ...
            if isinstance(grammar_expression, ElementaryKernelGrammarExpression):
                ...
                copied_expression.extend_sub_expression_at_index(
                    subexpression_index, operator, KernelFactory.build(base_kernel_config)
                )
                new_expression = copied_expression
        new_expression.set_generator_name(self.name)
        return new_expression

    def get_random_neighbour_expression(
        self, grammar_expression: BaseKernelGrammarExpression
    ) -> BaseKernelGrammarExpression:
        """
    ...
    def random_walk(
        self, length: int, initial_expression: BaseKernelGrammarExpression
    ) -> List[BaseKernelGrammarExpression]:
        """
    ...
    def filter_equivalent_expressions(
        self, expression_list: List[BaseKernelGrammarExpression]
    ) -> List[BaseKernelGrammarExpression]:
        filtered_list = []
        for expression in expression_list:
            if len(filtered_list) == 0:
                ...
                add_to_list = True
                for filtered_expression in filtered_list:
                    if self.check_expression_equality(expression, filtered_expression):
                        add_to_list = False
                if add_to_list:
                    filtered_list.append(expression)
        return filtered_list

    def get_complete_space(self, depth: int) -> List[BaseKernelGrammarExpression]:
        """
        Attention: very big!!
        """
        all_expressions = self.get_root_expressions()
        for i in range(0, depth):
            neighbours = []
            for expression in all_expressions:
                expression_neighbours = self.get_neighbour_expressions(expression)
                neighbours += self.filter_equivalent_expressions(expression_neighbours)
            all_expressions += self.filter_equivalent_expressions(neighbours)
        return self.filter_equivalent_expressions(all_expressions)

    def check_expression_equality(
        self, expression1: BaseKernelGrammarExpression, expression2: BaseKernelGrammarExpression
    ) -> bool:
        """
        ...
        """
        if all(
            [operator in [KernelGrammarOperator.ADD, KernelGrammarOperator.MULTIPLY] for operator in self.operator_list]
        ):
    ...
    def considers_single_dimensions(self):
        return self.has_single_dimensions
...
class CompositionalKernelSearchSpace(BaseKernelGrammarSearchSpace):
    def __init__(self, input_dimension: int):
        ...
        self.dimension_filling_bases = []
        self.has_single_dimensions = True
        for base_kernel_config_class in base_kernel_config_class_list:
            for i in range(0, input_dimension):
                ...
                if isinstance(kernel_config, RBFWithPriorConfig):
                    self.dimension_filling_bases.append(kernel_config)
...
class CKSWithRQTimeSeriesSearchSpace(BaseKernelGrammarSearchSpace):
    def __init__(self, input_dimension: int):
        super().__init__(input_dimension)
        base_kernel_config_class_list = [
            RBFWithPriorConfig,
...
class CKSTimeSeriesSearchSpace(BaseKernelGrammarSearchSpace):
    def __init__(self, input_dimension: int):
        super().__init__(input_dimension)
        base_kernel_config_class_list = [
            RBFWithPriorConfig,
...
class NDimFullKernelsSearchSpace(BaseKernelGrammarSearchSpace):
    def __init__(self, input_dimension: int):
        super().__init__(input_dimension)
        self.has_single_dimensions = False
        self.base_kernel_config_list = [
        ...
        self.dimension_filling_bases = [RBFWithPriorConfig(input_dimension=input_dimension)]
        self.operator_list = [KernelGrammarOperator.ADD, KernelGrammarOperator.MULTIPLY]
        self.name = self.__class__.__name__


class BigNDimFullKernelsSearchSpace(BaseKernelGrammarSearchSpace):
    def __init__(self, input_dimension: int):
        super().__init__(input_dimension)
        self.has_single_dimensions = False
        self.base_kernel_config_list = [
            RBFWithPriorConfig(input_dimension=input_dimension),
            LinearWithPriorConfig(input_dimension=input_dimension),
            RQWithPriorConfig(input_dimension=input_dimension),
            Matern52WithPriorConfig(input_dimension=input_dimension),
            Matern32WithPriorConfig(input_dimension=input_dimension),
        ]
        self.dimension_filling_bases = [RBFWithPriorConfig(input_dimension=input_dimension)]
        self.operator_list = [KernelGrammarOperator.ADD, KernelGrammarOperator.MULTIPLY]
        self.name = self.__class__.__name__
...
class BigLocalNDimFullKernelsSearchSpace(BaseKernelGrammarSearchSpace):
    def __init__(self, input_dimension: int):
        super().__init__(input_dimension)
        self.has_single_dimensions = False
        self.base_kernel_config_list = [
        ...
        self.dimension_filling_bases = [RBFWithPriorConfig(input_dimension=input_dimension)]
        self.operator_list = [KernelGrammarOperator.ADD, KernelGrammarOperator.MULTIPLY, KernelGrammarOperator.SPLIT_CH]
        self.name = self.__class__.__name__


class DynamicHierarchicalHyperplaneKernelSpace(BaseKernelGrammarSearchSpace):
    def __init__(self, input_dimension: int):
        super().__init__(input_dimension)
        self.has_single_dimensions = False
        self.base_kernel_config_list = [RBFWithPriorConfig(input_dimension=input_dimension)]
        self.dimension_filling_bases = [RBFWithPriorConfig(input_dimension=input_dimension)]
        self.operator_list = [KernelGrammarOperator.SPLIT_CH]
        self.name = self.__class__.__name__


class FlatLocalKernelSearchSpace(BaseKernelGrammarSearchSpace):
    def __init__(self, input_dimension: int):
        super().__init__(input_dimension)
        self.has_single_dimensions = False
        self.base_kernel_config_list = [
...
if __name__ == "__main__":
    search_space = DynamicHierarchicalHyperplaneKernelSpace(2)
    root_expression = search_space.get_root_expressions()[0]
    for expression in search_space.get_complete_space(7):
        print(expression)
